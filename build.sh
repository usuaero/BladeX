...
EXEOUT='be.out'              #name of output program
...
cd $SRCDIR
gfortran -fdefault-real-8 $CMSRC/json.f90 $CMSRC/myjson.f90 $CMSRC/math.f90 $CMSRC/dataset.f90 $CMSRC/airfoil.f90 $CMSRC/section.f90 prop.f90 view.f90 special_functions.f90 main.f90 -o $EXEOUT
cd ..
